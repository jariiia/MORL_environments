...
if __name__ == "__main__":
    optimal_actions = ['pick_up_bottle', 'right', 'right', 'right', 'right', 'left', 'left', 'left', 'left',
               'pick_up_bottle', 'right', 'right', 'right', 'right']
    suboptimal_actions = ['pick_up_bottle', 'pick_up_bottle', 'right', 'right', 'right', 'right','left', 'left', 'left', 'left','pick_up_bottle', 'right', 'right', 'right', 'right']
